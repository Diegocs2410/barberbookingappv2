export default {
	...
	auth: {
		...
		roleSelect: {
			...
			barber: 'Barbero',
			barberDescription: 'Trabaja en una barbería',
			owner: 'Dueño de Barbería',
			ownerDescription: 'Administra tu barbería, barberos y citas',
			continueButton: 'Continuar',
			barberNotLinkedTitle: 'Cuenta no vinculada',
			barberNotLinkedMessage: 'Tu cuenta aún no está vinculada a ninguna barbería. El dueño de la barbería debe agregarte usando tu correo electrónico.',
			barberLinkedSuccess: '¡Bienvenido! Has sido vinculado a la barbería exitosamente.',
			barberSearching: 'Buscando tu barbería...',
		},
	...
	owner: {
		...
		barbers: {
			...
			// Nuevas traducciones para vinculación
			linked: 'Vinculado',
			pending: 'Pendiente',
			linkBarber: 'Vincular Barbero',
			unlinkBarber: 'Desvincular Barbero',
			linkConfirm: '¿Deseas vincular este barbero con la cuenta de {{name}}? El usuario podrá ver sus citas.',
			unlinkConfirm: '¿Estás seguro de que quieres desvincular este barbero? El usuario perderá acceso al panel.',
			linkError: 'Error al vincular el barbero',
			unlinkError: 'Error al desvincular el barbero',
			searchingUser: 'Buscando usuario...',
			userFound: 'Usuario encontrado: {{name}}',
			userNotFound: 'No se encontró usuario con este correo. Se creará como pendiente.',
			errors: {
				nameRequired: 'El nombre es requerido',
